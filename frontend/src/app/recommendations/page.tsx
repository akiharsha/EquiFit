...
export default function RecommendationsPage() {
  ...
  // Mock data - in real app, this would come from API based on user's application data
  const internshipMatches: InternshipMatch[] = [
    {
      id: "1",
  ...
  const filteredAndSortedMatches = internshipMatches
